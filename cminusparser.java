...
//GRAMATICA EN LINEA 20
  ...
  final public void simple_expression_ending() throws ParseException {
                                   String aux = "";
    label_9:
    while (true) {
      if (jj_2_9(5)) {
    ...
    if (jj_2_12(20)) {
      ...
      default:
        ...
        if (jj_2_13(20)) {
          ...
          case NUMERO_ENTERO:
            jj_consume_token(NUMERO_ENTERO);
                                                                                                                                                 tamanio = Integer.parseInt(token.image); if(id!=aux) accesoArreglo(id, tamanio);
            break;
          case NUMERO_REAL:
